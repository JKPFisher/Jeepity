            ...
            if (dataSnapshot.exists()) {
                ...
                if (Lat !=null  && Long != null) {
                    ...
                    when {
                        ...
                        address.contains("Fernando G. Bautista Dr") ->  spinner_location.setSelection(1)
                        ...
                        address.contains("Ambiong-Lubas-Tawang Rd") ->  spinner_location.setSelection(3)
                        ...
                        address.contains("Bakakeng Central Rd 1") ->  spinner_location.setSelection(12)
                        ...
                        address.contains("Teacher’s Village Rd") ->  spinner_location.setSelection(12)
                        address.contains("Elisabeth Ct") ->  spinner_location.setSelection(12)
                        address.contains("Bakakeng Central Rd 3") ->  spinner_location.setSelection(12)
                        ...
                        address.contains("Baguio - La Trinidad - Bontoc Rd") ->  spinner_location.setSelection(23)
                        ...
                        address.contains("Western Link Circumferential Rd ") ->  spinner_location.setSelection(24)
                        ...
                        address.contains("Agpaoa Street Camp 7") ->  spinner_location.setSelection(24)
                        ...
                        address.contains("Upper Fairview Ferguson Rd") ->  spinner_location.setSelection(27)
                        ...
                        address.contains("Pucay Subdivision Rd") ->  spinner_location.setSelection(31)
                        ...
                        address.contains("DPS Compound Access Road") ->  spinner_location.setSelection(37)
                        ...
                        address.contains("Upper Fairview Ferguson Road") ->  spinner_location.setSelection(39)
                        ...
                        address.contains("Europa Entrance Road") ->  spinner_location.setSelection(40)
                        address.contains("Agoo - Baguio Road") ->  spinner_location.setSelection(40)
                        address.contains("Demonstration Mines Road") ->  spinner_location.setSelection(41)
                        ...
                        address.contains("Pucay Subdivision Rd") ->  spinner_location.setSelection(48)
                        ...
                        address.contains("Holy Ghost Hill Ext. Rd") ->  spinner_location.setSelection(54)
                        address.contains("Holy Ghost Road Extension") ->  spinner_location.setSelection(54)
                        ...
                        address.contains("Lower Justice Village Rd") ->  spinner_location.setSelection(57)
                        ...
                        address.contains("Holy Ghost Hill Ext. Rd") ->  spinner_location.setSelection(58)
                        ...
                        address.contains("Demonstration Mines Road") ->  spinner_location.setSelection(67)
                        ...
                        address.contains("Hamada Subdivision Rd") ->  spinner_location.setSelection(69)
                        ...
                        address.contains("Baguio - Bua - Itogon Rd") ->  spinner_location.setSelection(72)
                        address.contains("Gibraltar Rd") ->  spinner_location.setSelection(72)
                        address.contains("Wright Park Horse Stables") ->  spinner_location.setSelection(72)
                        ...
                        address.contains("Governor Center Extn") ->  spinner_location.setSelection(81)
                        ...
                        address.contains("Hamada Subdivision Rd") ->  spinner_location.setSelection(85)
                        ...
                        address.contains("Pines City Residences") ->  spinner_location.setSelection(86)
                        ...
                        address.contains("Lower Pinget Purok 3") ->  spinner_location.setSelection(93)
                        ...
                        address.contains("Maligcong Village Road") ->  spinner_location.setSelection(94)
                        ...
                        address.contains(" Lower Quirino Hill Rd") ->  spinner_location.setSelection(101)
